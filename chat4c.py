import os
import sqlite3
import requests  # Fallback for blob upload on Render
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///data/chat_app.db'  # PERSISTENT
...
with app.app_context():
    db.create_all()
    print("SQLite DB initialized at /data/chat_app.db")
...
<body>
  ...
  <div class="nexus-container">
    ...
    <div class="nexus-grid home">
      ...
      <section class="nexus-card filled">
        <h2 class="nexus-type-lg">Join Group</h>
